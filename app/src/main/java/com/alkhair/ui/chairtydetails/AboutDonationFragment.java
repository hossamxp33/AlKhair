...
public class AboutDonationFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        companydetails = (Result) args
                .getSerializable("companydetails");

        if (helper.getLang().equals("ar")) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                if ((companydetails != null && companydetails.getCharityMission_Ar() != null)) {
                    binding.details.setText(Html.fromHtml(companydetails != null ? companydetails.getCharityMission_Ar() : null, Html.FROM_HTML_MODE_COMPACT));
                }
                if ((companydetails != null && companydetails.getCharityVision_Ar() != null)) {
                    binding.goalDetails.setText(Html.fromHtml(companydetails != null ? companydetails.getCharityVision_Ar() : null, Html.FROM_HTML_MODE_COMPACT));
                }
                ...
                if ((companydetails != null && companydetails.getCharityMission_Ar() != null)) {
                    binding.details.setText(Html.fromHtml(companydetails != null ? companydetails.getCharityMission_Ar() : null));
                }
                if ((companydetails != null && companydetails.getCharityVision_Ar() != null)) {
                    binding.goalDetails.setText(Html.fromHtml(companydetails != null ? companydetails.getCharityVision_Ar() : null));
                }
                if ((companydetails != null && companydetails.getCharityAddress_Ar() != null)) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                if ((companydetails != null && companydetails.getCharityMission_En() != null)) {
                    binding.details.setText(Html.fromHtml(companydetails != null ? companydetails.getCharityMission_En() : null, Html.FROM_HTML_MODE_COMPACT));
                }
                if ((companydetails != null && companydetails.getCharityVision_En() != null)) {
                    binding.goalDetails.setText(Html.fromHtml(companydetails != null ? companydetails.getCharityVision_En() : null, Html.FROM_HTML_MODE_COMPACT));
                }
                ...
                if ((companydetails != null && companydetails.getCharityMission_En() != null)) {
                    binding.details.setText(Html.fromHtml(companydetails != null ? companydetails.getCharityMission_En() : null));
                }
                if ((companydetails != null && companydetails.getCharityVision_En() != null)) {
                    binding.goalDetails.setText(Html.fromHtml(companydetails != null ? companydetails.getCharityVision_En() : null));
                }
                if ((companydetails != null && companydetails.getCharityAddress_En() != null)) {
